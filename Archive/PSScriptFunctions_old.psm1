...
function ArrayBuilder{
	...
	$Findings | %{
		...
		switch($product){
			...
			"Tenable"	{$Array+= $obj | select Environment,Title,Severity,First_Observed,UpdatedAtShort,DueDate,ResourceId,Description,Remediation,FixURL,Note,Jira,FindingId,ProdArn
			}
